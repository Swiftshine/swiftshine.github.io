...
| flags             | `0x4`  | `0x4` | `u32`?      | Often seen to be `0x10` or `0x11`.                                                                      |
...
| scale modifier    | `0x30` | `0x4` | `float`     | Used in-game when rendering the cells.<sup>2</sup> This value is set to `1.0f` if the flags are `0x10`. |
